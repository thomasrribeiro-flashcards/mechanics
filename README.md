...
Card creation and auditing follow the deck-specific decisions in
[CARD_README.md](CARD_README.md) and the canonical standards in the flashcards
application repository. The deck complements—not replaces—solving novel mixed
mechanics problems on paper.
...
| 05_newtons_laws | Newton's 1st/2nd/3rd laws, inertia, inertial frames, FBDs |
| 06_forces | Weight, normal, tension, static/kinetic friction, spring, drag |
| 07_work_energy | Work, work-energy theorem, KE/PE, energy conservation, power |
| 08_momentum | Momentum, impulse, elastic/inelastic collisions, center of mass |
...
| [OpenStax, *University Physics Volume 1*, sections 2.1–2.4](https://openstax.org/books/university-physics-volume-1/pages/2-introduction) | Curricular and claim verification for geometric vectors, Cartesian components, vector addition, dot products, and three-dimensional cross products; no later-mechanics examples or source figures reused | CC BY-NC-SA 4.0; noncommercial adaptation permitted with attribution and share-alike; original deck prose, examples, and TikZ-authored SVGs used | 2026-07-15 |
| [OpenStax, *University Physics Volume 1*, preface](https://openstax.org/books/university-physics-volume-1/pages/preface) | License and edition-terms verification for the OpenStax source above | CC BY-NC-SA 4.0; OpenStax marks and covers excluded from the license | 2026-07-15 |
